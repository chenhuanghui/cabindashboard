                                    ...
                                    <table className="table table-sm table-nowrap card-table table-hover">
                                        <tbody className="list">{/* table item */} 
                                            <tr>
                                                ...
                                                <td className="col-8">
                                                    <h4 className="mb-1">tên thương hiệu</h4>
                                                    <small className="text-muted"> giới thiệu thương hiệu</small>
                                                </td>
                                                <td className='col-3'>
                                                    <span className="badge badge-success text-right">Đang hoạt động</span>
                                                </td>
                                            </tr>        
                                        </tbody>
                                    </table>
